...
import com.masslany.justevaluateit.presentation.components.rating.RatingBarUtils
import com.masslany.justevaluateit.presentation.components.rating.RatingBarUtils.stepSized
...
fun RatingBarPreview() {
    ...
    RatingBar(numStars = 10, value = rating, onValueChange = {
        rating = it
    }) {
